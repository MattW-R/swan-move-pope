...
export const getPropertyStatus = (property: Property, allTenants: Tenant[]): PropertyStatus => {
    const tenantsInProperty = allTenants.filter(tenant => tenant.propertyId === property.id);
